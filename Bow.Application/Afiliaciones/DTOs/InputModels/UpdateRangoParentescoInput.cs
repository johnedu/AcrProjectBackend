...
{
    public class UpdateRangoParentescoInput : IInputDto
    {
        [Required(ErrorMessageResourceName = "rangoParentesco_save_id_requerido", ErrorMessageResourceType = typeof(Bow.Resources.TextosValidacionDTO))]
