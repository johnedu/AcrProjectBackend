...
{
    public class UpdateGrupoFamiliarInput : IInputDto
    {
        [Required(ErrorMessageResourceName = "grupoFamiliar_save_id_requerido", ErrorMessageResourceType = typeof(Bow.Resources.TextosValidacionDTO))]
